...
CREATE TABLE "doctors" (
    ...
    "qualificationts" TEXT NOT NULL,
    "experienceYears" INTEGER NOT NULL,
    "bio" TEXT,
    "consultationFree" DECIMAL(10,2),
    "contactNumber" TEXT,
    "verificationStatus" "DoctorVerificationStatus" NOT NULL DEFAULT 'PENDING',
    "rejectionReason" TEXT,
    "revieweBy" TEXT,
    "revieweAt" TIMESTAMP(3),
    "resume" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "doctors_qualificationts_key" ON "doctors"("qualificationts");
